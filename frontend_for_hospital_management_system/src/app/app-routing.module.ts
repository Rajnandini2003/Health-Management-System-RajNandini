...
import { AdmindashComponent } from './admindash/admindash.component';  // Correct import path
import { AppointmentComponent } from './appointment/appointment.component';  // Correct import path
